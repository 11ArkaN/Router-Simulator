...
`pnpm verify` uruchamia walidację źródeł i profilu, typecheck, testy C++ i TypeScript, kontrolę regresji benchmarku oraz produkcyjny build. CI dodatkowo buduje rdzeń natywnie z AddressSanitizer, UndefinedBehaviorSanitizer i ThreadSanitizer.
