...
export function SettingsWorkspace({ project, onChange, onResetLayout }: SettingsProps) {
  ...
  return (
    <section className="workspace-page settings-page" aria-labelledby="settings-title">
      ...
      <label className="field-row"><span>Inspector width</span><input type="range" min={GENERATED_PROFILE.uiDefaults.inspector_width_min} max={GENERATED_PROFILE.uiDefaults.inspector_width_max} value={project.layout.inspectorWidth} onChange={(event) => onChange({ ...project, layout: { ...project.layout, inspectorWidth: Number(event.target.value) } })} /><small>{project.layout.inspectorWidth}px</small></label>
      <label className="field-row"><span>Terminal height</span><input type="range" min={GENERATED_PROFILE.uiDefaults.terminal_height_min} max={GENERATED_PROFILE.uiDefaults.terminal_height_max} value={project.layout.terminalHeight} onChange={(event) => onChange({ ...project, layout: { ...project.layout, terminalHeight: Number(event.target.value) } })} /><small>{project.layout.terminalHeight}px</small></label>
