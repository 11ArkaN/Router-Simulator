...
inline constexpr std::string_view dhcp_server_create{"dhcp-server-create"};
inline constexpr std::string_view dhcp_server_delete{"dhcp-server-delete"};
inline constexpr std::string_view dhcp_server_configuration_replace{"dhcp-server-configuration-replace"};
inline constexpr std::string_view dhcp_server_replace{"dhcp-server-replace"};
inline constexpr std::string_view dhcp_server_dhcpv4_replace{"dhcp-server-dhcpv4-replace"};
inline constexpr std::string_view dhcp_server_dhcpv6_replace{"dhcp-server-dhcpv6-replace"};
...
inline constexpr std::string_view host_ipv4_replace{"host-ipv4-replace"};
...
inline constexpr std::string_view host_dhcpv4_replace{"host-dhcpv4-replace"};
