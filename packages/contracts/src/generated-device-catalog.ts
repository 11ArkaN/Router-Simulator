...
export const PROFILE_CATALOG = {
  ...
  "runtime": {
    ...
    "runtime_control_reserve_bytes": 67108864,
    "low_cpu_max": 4,
    "medium_cpu_max": 8,
    ...
    "high_link_shards": 1,
    "pthread_pool_low": 2,
    "pthread_pool_medium": 4,
    "pthread_pool_high": 6,
    "maximum_worker_domains": 7,
    "worker_startup_attempts": 1000,
    ...
    "dynamic_routes_per_router": 8192,
    ...
    "ospf_packet_ring_frames": 256,
    "ospf_lsas_per_instance": 4096,
    "ospf_vertices_per_area": 2048,
    "ospf_edges_per_area": 8192,
    "ospf_neighbors_per_interface": 256,
    "ospf_work_budget_packets": 64,
    "ospf_v2_instances_per_router": 32,
    "ospf_v3_instances_per_router": 64,
    "ospf_v2_instance_first": 0,
    "ospf_v2_instance_last": 31,
    "ospf_v3_ipv6_instance_first": 0,
    "ospf_v3_ipv6_instance_last": 31,
    "ospf_v3_ipv4_instance_first": 64,
  ...
  "switch_profiles": [
    {
      "id": "generic-ethernet-24",
      "display_name": "Ethernet Switch 24",
      "port_count": 24,
      "supported_speeds_mbps": [
        1000,
        10000
      ],
      "default_speed_mbps": 10000,
      "minimum_mtu": 68,
      "maximum_mtu": 9212,
      "default_mtu": 9212,
      "default_admin_enabled": true,
      "queue_frames_per_port": 256,
      "fdb_entries": 4096,
      "fdb_aging_seconds": 300,
      "untagged_broadcast_domains": 1
    }
  ],
  "ipsec": {
  ...
  "protocol_defaults": {
    ...
    "ospf_transmit_delay_seconds": 1,
    "ospf_hello_interval_minimum_seconds": 1,
    "ospf_hello_interval_maximum_seconds": 65535,
    "ospf_dead_interval_minimum_seconds": 2,
    "ospf_dead_interval_maximum_seconds": 65535,
    "ospf_retransmit_interval_minimum_seconds": 1,
    "ospf_retransmit_interval_maximum_seconds": 1800,
    "ospf_transmit_delay_minimum_seconds": 1,
    "ospf_transmit_delay_maximum_seconds": 1800,
    "ospf_poll_interval_seconds": 120,
    "ospf_interface_cost": 0,
    ...
    "ospf_spf_initial_wait_milliseconds": 1000,
    "ospf_spf_second_wait_milliseconds": 1000,
    "ospf_spf_maximum_wait_milliseconds": 10000,
    "ospf_lsa_initial_wait_milliseconds": 5000,
    "ospf_lsa_second_wait_milliseconds": 5000,
    "ospf_lsa_maximum_wait_milliseconds": 5000,
    "ospf_lsa_refresh_seconds": 1800,
    "ospf_lsa_max_age_seconds": 3600,
    "ospf_min_lsa_interval_seconds": 5,
    "ospf_min_ls_arrival_seconds": 1,
